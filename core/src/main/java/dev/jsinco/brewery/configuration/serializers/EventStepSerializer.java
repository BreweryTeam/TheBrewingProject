...
public class EventStepSerializer implements ObjectSerializer<EventStep> {
    ...
    public EventStep deserialize(@NonNull DeserializationData data, @NonNull GenericsDeclaration generics) {
        ...
        if (data.containsKey("condition")) {
            ...
            Preconditions.checkArgument(condition.getClass() != Condition.NotCondition.class, "Unimplemented wait condition: 'not', use if-condition instead");
            Preconditions.checkArgument(condition.getClass() != Condition.ModifierAbove.class, "Unimplemented wait condition: 'modifier-above', use if-condition instead");
